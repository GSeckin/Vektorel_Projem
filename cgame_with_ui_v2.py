...
class Iskambil:
    ...
    def __init__(self,cardType,cardValue,cardValue_int):
        ...
        self.photo = "C:\\Users\\Görkem\\Documents\\GitHub\\Python6Desktop\\Yeni (Gui)\\deste_taslak1\\" + self.name + ".png"
...
class Ana(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.win = uic.loadUi(r"C:\Users\Görkem\Documents\GitHub\Python6Desktop\Yeni (Gui)\cardgame_Table6.ui")
    ...
    def gui_el_playerABC(self,shuffled_list):
        ...
        im_el_dolu = QPixmap(r"C:\Users\Görkem\Documents\GitHub\Python6Desktop\Yeni (Gui)\card_hand_tiltedx3_27percent.jpg")
